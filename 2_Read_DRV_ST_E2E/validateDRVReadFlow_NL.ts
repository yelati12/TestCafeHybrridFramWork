...
let drvPolicyData = require('../DataFiles/ST/DRV/readDRVInsurancePolicy_NL.json')
      ...
      test(`Validate DRV Read Flow - Your Insurance Section`, async t => {
         ...
         if (await objRepository.login.acceptCookie.exists) {
           ...
           sessionStorage.setItem(prop,value);  
            ...
            await utility.handleObjects(t, objRepository.annualTravelInsurancePage.annualTravelInsurancePageHeader, 'Annual Travel Insurance page header', 'VALIDATE TEXT', 'Doorlopende reisverzekering')
            t.debug();
            await utility.handleObjects(t,objRepository.annualTravelInsurancePage.yourInsuranceHeader, 'Your Insurance header', 'VALIDATE TEXT','Uw verzekering')
            ...
            if (await objRepository.annualTravelInsurancePage.premiumLabel.exists) {
               await utility.handleObjects(t, objRepository.annualTravelInsurancePage.premiumAmount, 'Premium Amount', 'VALIDATE TEXT CONTAINS', data.Premium)
            }else{
               await t.takeScreenshot()
            }
            ...
            if (await objRepository.annualTravelInsurancePage.premiumText.exists) {
               await utility.handleObjects(t, objRepository.annualTravelInsurancePage.premiumText, 'Premium Text', 'VALIDATE TEXT CONTAINS', data.premiumText)
            ...
            if (await objRepository.annualTravelInsurancePage.termsAndConditionsText.exists) {
               await utility.handleObjects(t, objRepository.annualTravelInsurancePage.termsAndConditionsText, 'policy terms and conditions Text', 'VALIDATE TEXT CONTAINS', 'Bekijk voor een volledig overzicht altijd uw polis en voorwaarden.')
      ...
      if (await objRepository.login.acceptCookie.exists) {
        ...
        sessionStorage.setItem(prop,value);    
         ...
         if (await objRepository.annualTravelInsurancePage.changeYourInsuranceHeader.exists) {
            await utility.handleObjects(t, objRepository.annualTravelInsurancePage.changeYourInsuranceHeader, 'Changing your Insurance header', 'VALIDATE TEXT CONTAINS', 'Uw verzekering wijzigen')    
            await utility.handleObjects(t, objRepository.annualTravelInsurancePage.changeYourInsuranceText, 'Changing your Insurance text', 'VALIDATE TEXT CONTAINS', data.changeYourInsuranceText)                      
         ...
         if (await objRepository.login.acceptCookie.exists) {
           ...
           sessionStorage.setItem(prop,value);  
            ...
            if (await objRepository.annualTravelInsurancePage.policyDetailsHeader.exists) {
               await utility.handleObjects(t, objRepository.annualTravelInsurancePage.policyDetailsHeader, 'Policy details header', 'VALIDATE TEXT', 'Polisgegevens')    
            }else{
               await t.takeScreenshot()
            }
